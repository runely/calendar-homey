 ...
 * @property {import('../types/VariableMgmt.type').VariableManagementCalendars} oldCalendars - Currently loaded calendars
 * @property {import('../types/VariableMgmt.type').VariableManagementCalendars} newCalendars - Calendars to be loaded
 */

/**
 * @param {FilterUpdatedCalendarsOptions} options
 *
 * @returns VariableMgmtCalendars
 */
