...
const removeInvalidTZ = (app, event, calendarName) => {
  ...
  try {
    ...
    app.error('getActiveEvents: Failed to remove invalid time zone:', error)
  ...
  for (const event of Object.values(data)) {
    ...
    if (typeof event.rrule !== 'undefined') {
      try {
        ...
        app.error(`Recurring event '${event.summary}' (${event.uid}) is invalid : `, error)
      ...
      try {
        ...
        app.error(`Regular event '${event.summary}' (${event.uid}) is invalid : `, error)
