    ...
    try {
      ...
      if (event.recurrences !== undefined) {
        for (const recurrenceDate of Object.keys(event.recurrences)) {
          ...
          const rMomentRecurr = recurrence.recurrenceid.toUTCString().includes('00:00:00') ? moment({ date: recurrence.recurrenceid }) : moment({ date: recurrence.recurrenceid, timezone })
