 ...
 * @param {Array} oldCalendars - Imported calendars
 ...
 * @returns {*[]} Imported calendars where all calendar events have been filtered by a specified property
 */
 ...
 * @returns {*[]} - Array with the found calendar or an empty array
 */
 ...
 * @param {Matcher} matcher - Which matcher method to use
 * @returns {*[]} oldCalendars where all calendar events have been filtered by summary
 */
 ...
 * @param {Matcher} matcher - Which matcher method to use
 * @returns {*[]} oldCalendars where all calendar events have been filtered by description
 */
 ...
 * @param {Matcher} matcher - Which matcher method to use
 * @returns {*[]} oldCalendars where all calendar events have been filtered by location
 */
 ...
 * @returns {*[]} oldCalendars where all calendar events have been filtered by uid
 */
