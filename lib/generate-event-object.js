 ...
 */
const fromEvent = (app, timezone, event) => {
 ...
 * @property {string} event_name - Title of the event
 * @property {string} event_description - Description for the event
 * @property {string} event_start - ISOString representing the start datetime
 * @property {string} event_end - ISOString representing the end datetime
 * @property {boolean} apply_timezone - Apply your timezone to start and end datetime
 * @property {string} calendar - Calendar this event will be added to
 */
 ...
 * @returns {LocalEvent}
 */
const newEvent = (app, timezone, args) => {
