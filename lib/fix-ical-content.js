...
module.exports = (ical) => {
    ...
    // replace "DTSTART;VALUE=DATE-TIME"
    ical = ical.replace(/DTSTART;VALUE=DATE-TIME/g, "DTSTART_TIMESTAMP");
    ...
    // replace "DTEND;VALUE=DATE-TIME"
    ical = ical.replace(/DTEND;VALUE=DATE-TIME/g, "DTEND_TIMESTAMP");
