 ...
 * @param {import('../types/ExtendedHomeyApp.type').ExtHomeyApp|import('../types/AppTests.type').AppTests} app - App class init by Homey
 *
 * @returns {undefined|import('../types/HitCount.type').HitCountData}
 */
...
/**
 * @param {import('../types/ExtendedHomeyApp.type').ExtHomeyApp|import('../types/AppTests.type').AppTests} app - App class init by Homey
 * @param {import('../types/HitCount.type').HitCountData} data
 */
...
const resetTodayHitCount = (app) => {
  ...
  if (!data) {
    app.warn("resetTodayHitCount : Tried to reset hit count for today but hit count data hasn't been populated yet")
    return
  }
 ...
 * @param {undefined|Object} args - Run listener arguments
 */
const updateHitCount = (app, id, args = undefined) => {
  const data = getHitCountData(app)

  if (!data) {
    app.warn('updateHitCount : Tried to update hit count for', id, "but hit count data hasn't been populated yet")
    return
  }
