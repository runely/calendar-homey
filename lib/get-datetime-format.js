...
module.exports = app => {
  const dateFormat = app.homey.settings.get(app.variableMgmt.setting.dateFormat) || Homey.__('settings.datetime.date.default')
  const timeFormat = app.homey.settings.get(app.variableMgmt.setting.timeFormat) || Homey.__('settings.datetime.time.default')
