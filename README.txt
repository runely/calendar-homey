...
- 0.0.3
    - Events in condition card is now presented with a date (and time if present)
    - Message when settings saved
    - Show message in settings if uri fails to load
    - Importing only active events. This is a significantly performance improvement!
