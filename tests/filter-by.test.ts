...
describe("filterByProperty", () => {
  describe("summary - matcher:contains", () => {
    test("Return 2 calendars with 1 event each - summary 'One'", () => {
      ...
      assert.strictEqual(result[0].events[0].summary, "One - 1");
      assert.strictEqual(result[1].name, "CalendarTwo");
      assert.strictEqual(result[1].events.length, 1);
      assert.strictEqual(result[1].events[0].summary, "One - 2");
    });
    ...
    test("Return 2 calendars with 0 events - summary 'Three'", () => {
      ...
      assert.strictEqual(result[1].name, "CalendarTwo");
      assert.strictEqual(result[1].events.length, 0);
    });
  ...
  describe("summary - matcher:ends with", () => {
    test('Return 2 calendars with 2 events in CalendarOne - summary "1"', () => {
      ...
      assert.strictEqual(result[0].events[0].summary, "One - 1");
      assert.strictEqual(result[0].events[1].summary, "Two - 1");
      assert.strictEqual(result[1].name, "CalendarTwo");
      assert.strictEqual(result[1].events.length, 0);
    });
    ...
    test('Return 2 calendars with 2 events in CalendarTwo - summary "2"', () => {
      ...
      assert.strictEqual(result[1].events[0].summary, "One - 2");
      assert.strictEqual(result[1].events[1].summary, "Two - 2");
    });
  ...
  describe("description - matcher:contains", () => {
    test('Return 2 calendars with 1 event each - description "One"', () => {
      ...
      assert.strictEqual(result[0].name, "CalendarOne");
      assert.strictEqual(result[0].events.length, 1);
      assert.strictEqual(result[0].events[0].description, "One - 1");
      assert.strictEqual(result[1].name, "CalendarTwo");
      assert.strictEqual(result[1].events.length, 1);
      assert.strictEqual(result[1].events[0].description, "One - 2");
    });
  ...
  describe("location - matcher:contains", () => {
    test('Return 2 calendars with 1 event each - location "One"', () => {
      ...
      assert.strictEqual(result[0].name, "CalendarOne");
      assert.strictEqual(result[0].events.length, 1);
      assert.strictEqual(result[0].events[0].location, "One - 1");
      assert.strictEqual(result[1].name, "CalendarTwo");
      assert.strictEqual(result[1].events.length, 1);
      assert.strictEqual(result[1].events[0].location, "One - 2");
    });
