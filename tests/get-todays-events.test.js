...
describe('Todays event count is', () => {
  test('2 when \'specificCalendarName\' is NOT given', () => {
    ...
    expect(todaysEvents[0].start instanceof momentInstance).toBe(true)
    expect(todaysEvents[0].end instanceof momentInstance).toBe(true)
    ...
    expect(todaysEvents[1].start instanceof momentInstance).toBe(true)
    expect(todaysEvents[1].end instanceof momentInstance).toBe(true)
